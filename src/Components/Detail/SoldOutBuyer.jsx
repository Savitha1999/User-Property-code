          ...
          properties.map((property) => (
            <div key={property.ppcId} className="property-card">
              ...
              <div className="buyers-list">
                {Array.isArray(property.soldOutRequesters) && property.soldOutRequesters.length > 0 ? (
                  ...
                  >
                    <div className="row d-flex align-items-center">
                      ...
                      <div className="col-7 p-0 ms-4">
                        <div className='text-center rounded-1 w-100 mb-1' style={{border:"2px solid #30747F", color:"#30747F", fontSize:"13px"}}>SOLDOUT BUYER</div>
