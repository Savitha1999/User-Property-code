                  ...
                  >
                    <div className="row d-flex align-items-center">
                      ...
                      <div className="col-7 p-0 ms-4">
                        <div className='text-center rounded-1 w-100 mb-1' style={{border:"2px solid #30747F", color:"#30747F", fontSize:"13px"}}>REPORT REQUESTED</div>
                   ...
                   <button
                         ...
                         >
                          ...
                          <button className="btn text-white px-3 py-1 flex-grow-1 mx-1"
                            ...
                            onClick={() => handleRemoveReport(property.ppcId, user)}> Remove</button>
                    </div>
                    : ''}
